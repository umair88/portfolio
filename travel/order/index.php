...
<div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="message" rows="14" style="margin: 10px 40px auto; width: 1035px; height: 180px;"></textarea>
            </div>
            
            <!--               End of Right -->
        </div>
        <!-- End of form -->
        <input class="botton-contact" type="submit" name="insert" value="Submit" />
    ...
    $('#passenger').change(function(){
       var numberOfPesngers = $('#passenger').val();
        ...
        for(i=1; i <= numberOfPesngers; i++ ){
            var html ="<h6 style='color:#151515;'>Passenger "+ i +"</h6> <div class='form-group'><p>First Name<span>*</span></p>";
